...
public final class CrowdCacheProto {
  ...
  public interface CrowdCacheMsgOrBuilder extends
     ...
     * <code>required .CrowdCacheMsg.MsgType msgType = 1;</code>
     */
    CrowdCacheMsg.MsgType getMsgType();
  ...
  public  static final class CrowdCacheMsg extends
    ...
    protected FieldAccessorTable
      ...
      return CrowdCacheProto.internal_static_CrowdCacheMsg_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CrowdCacheMsg.class, Builder.class);
    }
    ...
    public enum MsgType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return CrowdCacheMsg.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public MsgType getMsgType() {
      ...
      return result == null ? MsgType.GET_REQ : result;
    }
    ...
    public static CrowdCacheMsg parseFrom(
    ...
    public static CrowdCacheMsg parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CrowdCacheMsg parseFrom(
    ...
    public static CrowdCacheMsg parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CrowdCacheMsg parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static CrowdCacheMsg parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(CrowdCacheMsg prototype) {
    ...
    public static final class Builder extends
      ...
      public CrowdCacheMsg getDefaultInstanceForType() {
        return CrowdCacheMsg.getDefaultInstance();
      }

      public CrowdCacheMsg build() {
        CrowdCacheMsg result = buildPartial();
      ...
      public CrowdCacheMsg buildPartial() {
        CrowdCacheMsg result = new CrowdCacheMsg(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CrowdCacheMsg) {
          return mergeFrom((CrowdCacheMsg)other);
        } else {
      ...
      public Builder mergeFrom(CrowdCacheMsg other) {
        if (other == CrowdCacheMsg.getDefaultInstance()) return this;
        if (other.hasMsgType()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CrowdCacheMsg parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CrowdCacheMsg) e.getUnfinishedMessage();
          throw e;
        } finally {
  ...
  bitField0_ |= 0x00000004;
    ...
    private static final CrowdCacheMsg DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CrowdCacheMsg();
    }

    public static CrowdCacheMsg getDefaultInstance() {
